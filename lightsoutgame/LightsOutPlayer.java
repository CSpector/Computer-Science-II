...
class LightsOutPlayer extends JFrame {
    ...
    /**
     * Passes the lights out class its parameters then creates the UI
     */
    ...
    /**
     * Checks to see if a square is lit
     */
    ...
    /**
     * Tracks the information of the board
     */
    class GridListener implements ActionListener {
        ...
        private int col;
        /**
         * Tracks the actions on the grid
         * @param row
         * @param col 
         */
