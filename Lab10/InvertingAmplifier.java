/**
 * InvertingAmplifier is called from AmplifiersApp and constructs an object
...
public class InvertingAmplifier extends Amplifier
{
  ...
  */
  static double rr2 = 0;
  /**
  * InvertingAmplifier calls the Amplifier class and stores the Resistance values
  ...
  */
   ...
   */
   ...
   {
     return "InvertingAmplifier: " + "R1 = " + rr1 + "," + "R2 = " + rr2;
   }
 }
